...
public class AgentBehavior extends Behavior {
    ...
    public void emptyBehavior(){
    	//publicationNode.removeChild(//); 

    	TransformGroup parent= (TransformGroup) targetTG.getParent().getParent();
    	parent.removeChild(targetTG.getParent());
    	//parent.removeAllChildren();
    	//this.translation.setTranslation(new Vector3f(0f,0f,0f));
    }
}
